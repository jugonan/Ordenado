...
namespace DEFINITIVO.Migrations
{
    ...
    [Migration("20200722152956_AddOpcionProductoInVisitaModel")]
    partial class AddOpcionProductoInVisitaModel
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Heldu.Entities.Models.ImagenesProducto", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Heldu.Entities.Models.OpcionProducto", b =>
                {
                    ...
                    b.Property<float>("PrecioInicial")
                        .HasColumnType("float");
            ...
            modelBuilder.Entity("Heldu.Entities.Models.Producto", b =>
                {
                    ...
                    b.Property<DateTime>("FechaAltaProducto")
                        .HasColumnType("datetime(6)");
            ...
            modelBuilder.Entity("Heldu.Entities.Models.ImagenesProducto", b =>
                {
                    b.HasOne("Heldu.Entities.Models.Producto", null)
                        .WithOne("ImagenesProducto")
                        .HasForeignKey("Heldu.Entities.Models.ImagenesProducto", "ProductoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("Heldu.Entities.Models.Visita", b =>
                {
                    b.HasOne("Heldu.Entities.Models.OpcionProducto", "OpcionProducto")
                        .WithMany()
                        .HasForeignKey("OpcionProductoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
