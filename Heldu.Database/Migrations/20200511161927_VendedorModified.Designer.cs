...
namespace DEFINITIVO.Migrations
{
    ...
    [Migration("20200511161927_VendedorModified")]
    partial class VendedorModified
    {
            ...
            modelBuilder.Entity("Heldu.Entities.Models.Ubicacion", b =>
                {
                    b.HasOne("Heldu.Entities.Models.Usuario", null)
                        .WithOne("Ubicacion")
                        .HasForeignKey("Heldu.Entities.Models.Ubicacion", "UsuarioId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Heldu.Entities.Models.Vendedor", null)
                        .WithOne("Ubicacion")
                        .HasForeignKey("Heldu.Entities.Models.Ubicacion", "VendedorId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
